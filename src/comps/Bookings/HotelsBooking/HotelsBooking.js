...
import './HotelsBooking.css'

const HotelsBooking = () => {
    const { register, handleSubmit, formState: { errors }, reset } = useForm();

    const handleHotelsBooking = (data) => {
        ...
        const hotelsBooking = {
            HotelsDestination: destination,
            returnDate: returnDate,
            journeyDate: journeyDate,
            person: person
        }
        console.log(hotelsBooking)
        toast.success('Hotels Booking SuccessFully Done')
        reset()
    }
    return (
        <>
            <form onSubmit={handleSubmit(handleHotelsBooking)}>
