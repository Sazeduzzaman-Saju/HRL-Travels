            ...
            <div class="  flex items-center justify-center px-5 py-5">
                <div class="bg-gray-100 text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden" >
                    <div class="md:flex w-full">
                        <div class="hidden md:block w-1/2 bg-[#0F298A] py-10 px-10">
                        ...
                        <div class="w-full md:w-1/2 py-10 px-5 md:px-10">
                            ...
                            <div>
                                ...
                                <div class="flex -mx-3">
                                    <div class="w-full px-3 mb-5 flex flex-col justify-center items-center ">
                                        <button class="button-86">REGISTER NOW</button>
                                    </div>
                                </div>
                                <div class=" w-96 mx-auto text-center">
                                    <p>Already Have Account <Link to={'/login'} className="text-[#0F298A]">Login</Link> Now</p>
                                    <p class="text-lg  mr-4 text-center mb-8">Sign in with</p>
                                </div>
                                <div class="">
